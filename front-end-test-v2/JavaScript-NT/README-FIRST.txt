...
Your company values the following coding standards:
 ...
 Refactor this project to the best of your ability using AngularJS. You can write whatever extra classes that may be necessary to tidy up.
 Please also provide evidence that you have tested that your changes all work correctly.

 You may:
	- Modify any existing files that are not contained in "do-not-refactor" directory
